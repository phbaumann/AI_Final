...
public class Drosophila {
	...
	public static void main(String[] args) {
		...
		//TODO read from cmd
		filename = "C://Desktop/flyData.txt";
		...
		for(int i =0; i < init.getSize(); i++){
			sortedFlies.add(init.getMember(i));
		}
		...
		for(int i = 0; i < numPops; i++){
			...
			newPop.saveMemeber(sortedFlies(i));
